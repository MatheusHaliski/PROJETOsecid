...
<header onmouseover="handleHover1()">
    <h1> Lista de Funcionarios Regional Cascavel<h1>
</header>
<nav>
        <a href="http://127.0.0.1:5502/cardd.html">Info Procedimentos</a>
        <a href="https://www.secid.pr.gov.br/">Sobre a SECID</a>
        <a href="https://www.secid.pr.gov.br/">Serviços</a>
        <a href="https://www.secid.pr.gov.br/Concidades/Pagina/Contatos">Contato</a>
</nav>
<div id="ao9">
...
$result = mysqli_query($connection,$sqe);
...
<table border="4">
    <tr>
        <td colspan="7" id="ww2">
<strong>SERVIDORES CASCAVEL</strong>
    </td>
    </tr>
    <tr>
        <th>ID_Servidor</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><form action='Delete3.php' method='post'>
                  <input type='hidden' name='id1' value='{$row['ID_Servidor']}'>
