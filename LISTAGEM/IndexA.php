...
<header onmouseover="handleHover1()">
    <h1> Lista de Funcionarios SECID Curitiba<h1>
</header>
<nav>
        <a href="#">Home</a>
        <a href="#">Sobre</a>
...
$result = mysqli_query($connection,$ffaf);
...
<table border="4">
    <tr>
        <td colspan="7" id="ww2">
<strong>SECID/CURITIBA - FUNCIONARIOS</strong>
    </td>
    </tr>
    <tr>
        <th>ID</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><form action='Delete3.php' method='post'>
                  <input type='hidden' name='id23' value='{$row['ID']}'>
