...
<header onmouseover="handleHover1()">
    <h1> Filtro de Funcionarios Regional Londrina<h1>
</header>
<nav>
        <a href="#">Home</a>
        <a href="#">Sobre</a>
...
$queryw = "SELECT ID_Servidor AS ID,Nome,Funcao,Ramal,Celular,Email FROM ServidoresLondrina WHERE Nome LIKE '$var1%' AND Funcao LIKE '$var2%';";
$result = mysqli_query($connection,$queryw);
?>
<table border="4">
    <tr>
        <td colspan="7" id="ww2">
<strong>SERVIDORES LONDRINA</strong>
    </td>
    </tr>
    <tr>
        <th>ID_Servidor</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><form action='Delete3.php' method='post'>
                  <input type='hidden' name='id4' value='{$row['ID']}'>
