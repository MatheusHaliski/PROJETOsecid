...
<header onmouseover="handleHover1()">
    <h1> Filtro de Funcionarios SECID Cascavel<h1>
</header>
<nav>
        <a href="#">Home</a>
        <a href="#">Sobre</a>
...
$queryw = "SELECT ID_Servidor AS ID,Nome,Funcao,Ramal,Celular,Email FROM ServidoresCascavel WHERE Nome LIKE '$var1%' AND Funcao LIKE '$var2%';";
