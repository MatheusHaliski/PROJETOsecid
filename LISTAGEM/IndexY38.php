...
<header onmouseover="handleHover1()">
    <h1> Filtro de Funcionarios Regional Umuarama<h1>
</header>
<nav>
        <a href="#">Home</a>
        <a href="#">Sobre</a>
...
$queryw = "SELECT ID_Servidor AS ID,Nome,Funcao,Ramal,Celular,Email FROM ServidoresUmuarama WHERE Nome LIKE '$var1%' AND Funcao LIKE '$var2%';";
$result = mysqli_query($connection,$queryw);
?>
<table border="4">
    <tr>
        <td colspan="7" id="ww2">
<strong>SERVIDORES UMUARAMA</strong>
    </td>
    </tr>
    <tr>
        <th>ID_Servidor</th>
