...
<header onmouseover="handleHover1()">
    <h1>  Flitro de Funcionarios Regional Curitiba<h1>
</header>
<nav>
        <a href="#">Home</a>
        <a href="#">Sobre</a>
...
$queryw = "SELECT ID_Servidor AS ID,Nome,Funcao,Ramal,Celular,Email FROM ServidoresCuritiba WHERE Nome LIKE '$var1%' AND Funcao LIKE '$var2%';";
$result = mysqli_query($connection,$queryw);
?>
<table border="4">
    <tr>
        <td colspan="7" id="ww2">
<strong>SERVIDORES CURITIBA</strong>
    </td>
    </tr>
    <tr>
        <th>ID_Servidor</th>
